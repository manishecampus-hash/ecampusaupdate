...
const testimonials: TestimonialCard[] = [
  {
    ...
    quote:
      "The Online B.Sc program helped me build a strong foundation in calculus, data structures, and scientific modeling. Recorded lectures and flexible classes made it easy to study while preparing for internships.",
  },
  {
    id: "2",
    name: "Rohan Agarwal",
    ...
    quote:
      "I wanted a science degree that would let me continue working part-time. The online format gave me flexibility, and the curriculum was practical for data analytics, research, and technical career paths.",
  },
  {
    id: "3",
    name: "Ananya Sharma",
    ...
    quote:
      "The best part was how simple the learning platform was. I could attend live laboratory simulations, revise recorded classes, and submit assignments without disrupting my daily schedule.",
  },
  {
    id: "4",
    name: "Karan Malhotra",
    ...
    quote:
      "The program helped me understand statistical inference, programming logic, and research methods in a structured way. Faculty support and study material made the online learning experience smooth and useful.",
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-5">
          <h2 className="mt-4 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl">
            B.Sc Student <span className="text-red-500">Testimonials</span>
          </h2>

          <p className="mt-4 text-base leading-relaxed text-slate-600">
            Hear from learners who completed flexible online science programs
