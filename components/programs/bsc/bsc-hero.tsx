...
const highlights = [
  ...
  { label: "Total Fees", value: "INR 90,000", icon: IndianRupee },
  { label: "EMI Starts", value: "INR 2,500/mo", icon: CreditCard },
  { label: "Mode", value: "100% Online", icon: BookOpen },
];

export default function BscGeneralHero() {
    ...
    <section className="relative overflow-hidden border-b border-slate-100 bg-slate-50 pt-12 pb-14 lg:pt-14 lg:pb-16">
      <div className="absolute inset-0 opacity-[0.03] [mask-image:linear-gradient(to_bottom,white,transparent)]">
        <svg className="h-full w-full" fill="none" viewBox="0 0 400 400">
          ...
          <rect width="100%" height="100%" fill="url(#bsc-general-grid)" />
        </svg>
      </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-black leading-tight tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
              Online Bachelor of{" "}
              <span className="text-red-500">Science (B.Sc)</span>
            </h1>

            <p className="mt-5 max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg">
              Develop fundamental scientific knowledge, analytical workflows,
              empirical research methods, and critical problem-solving skills
              through a flexible online degree program.
            </p>
          ...
          <div className="relative">
            <div className="relative z-10 overflow-hidden rounded-3xl shadow-2xl ring-1 ring-slate-200">
              <img
                src="https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=1000&auto=format&fit=crop&q=80"
                alt="Online Bachelor of Science Core Laboratory Environment"
            ...
            <div className="absolute -right-4 top-6 z-20 hidden rounded-2xl bg-white/90 p-4 shadow-xl ring-1 ring-slate-100 backdrop-blur lg:block">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-black text-gray-900">4.6/5</p>
                </div>
              </div>
            </div>
          </div>
